...
const ValidationFormUSA = () => {
  ...
  const suffix = ["Sr.", "Jr.", ""];
  const streetType = ["Street" , "St." , "Ave." , "Blvd." , "Rd." , "Dr." , "Ct." , "Pl." , "Way" , "Terr." , "Ln."];
              ...
              <div className="sm:col-span-4">
                ...
                <div className="mt-2">
                    <input
                      ...
                      pattern="\d{5}"
                      placeholder="98004"
                      className="block w-30 mr-3 pl-1 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    />
                </div>
              </div>
...
export default ValidationFormUSA;
